...
<link href="{{asset('assets/main.07a59de7b920cd76b874.css')}}" rel="stylesheet"></head>
<body>
                                                ...
                                                <div class="widget-content p-0">
                                                    <div class="widget-content-wrapper">
                                                        <div class="widget-content-left mr-3">
                                                            ...
                                                            src="{{asset('storage/' . Auth::user()->avater )}}"
                                                                    alt="">
                                                        </div>
                                                        <div class="widget-content-left">
...
<script type="text/javascript" src="{{asset('assets/scripts/main.07a59de7b920cd76b874.js')}}"></script></body>
