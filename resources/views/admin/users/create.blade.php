                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.users.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" name="birthday" value="{{ old('birthday') }}" class="form-control @error('birthday') is-invalid @enderror" data-toggle="datepicker">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="avater" type="file" class="form-control @error('avater') is-invalid @enderror" name="avater" autocomplete="avater" autofocus>
                        ...
                        <label class="checkbox-inline ">
                                            ...
                                            <input name="role_id" type="checkbox" class="mr-2 mt-2  @error('role_id') is-invalid @enderror" value="{{$role->id}}"> {{$role->name}}
                                            @endforeach
                                        </label>
                                        @error('role_id')
                                <span class="invalid-feedback" role="alert">
