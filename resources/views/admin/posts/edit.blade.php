                            ...
                            <div class="col-sm-10">
                                <div class="position-relative form-check">
                                    ...
                                    <label class="form-check-label">
                                        ...
                                        <input name="category_id[]" type="checkbox" class="form-check-input"
                                        @if(in_array($categoryType->id,$categories))
                                           checked
                                ...
                                <div class="col-sm-10">
                                    <div class="position-relative form-check">
                                        ...
                                        <label class="form-check-label">
                                                ...
                                                <input name="tag_id[]" type="checkbox"  class="form-check-input"
